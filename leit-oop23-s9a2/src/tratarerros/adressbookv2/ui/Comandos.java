...
import tratarerros.adressbookv2.exceptions.ComandoInvalidoException;
...
public class Comandos
{
     ...
     */
    public boolean isCommand(String aString) throws ComandoInvalidoException {
        if(aString != null) {
            try {
                ...
                throw new ComandoInvalidoException(aString);
            }
